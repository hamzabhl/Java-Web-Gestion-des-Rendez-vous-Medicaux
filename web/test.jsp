...
<html lang="fr">
    ...
    <body>
        ...
        <div class="main-container">
            ...
            <div class="form-box">
                <!-- Form Patient -->
                <form id="formPatient" class="form-section active" action="PatientSignupServlet" method="post">
                ...
                <!-- Form Medecin -->
                <form id="formMedecin" class="form-section" action="MedecinSignupServlet" method="post">
